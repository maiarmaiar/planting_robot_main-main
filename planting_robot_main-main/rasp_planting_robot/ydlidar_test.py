...
dist_ignore = 0.01
DETECT_DISTANCE = 1.0  # Set your desired detection threshold here
            ...
            if r:
                ...
                for point in scan.points:
                    ...
                    if distance >= dist_ignore:
                        ...
                        # Check distances within specified angle ranges
                        if distance < DETECT_DISTANCE:  # Only consider distances below the detection threshold
                ...
                if ( min_distance_left <= threshold):
                    print(f"Min distance left: {min_distance_left} at angle: {min_angle_left}")
                if ( min_distance_center <= threshold):
                    print(f"Min distance center: {min_distance_center} at angle: {min_angle_center}")
                if ( min_distance_right <= threshold):
                    print(f"Min distance right: {min_distance_right} at angle: {min_angle_right}")
            else:
